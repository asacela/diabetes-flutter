              ...
              child: Stack(
                children: [
                  Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0), // Add some padding if necessary
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(36.0), // Set the desired border radius
                        child: Container(
                          ...
                          child: FloatingActionButton(
                            ...
                            backgroundColor: Colors.blue, // Replace with your secondaryColor
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16.0)), // Ensure shape matches the ClipRRect
                          ),
                        ),
                      ),
                    ),
